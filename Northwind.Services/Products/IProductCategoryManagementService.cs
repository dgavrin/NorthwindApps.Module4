...
{
    /// <summary>
    /// Represents a managment service for product categories.
    /// </summary>
    public interface IProductCategoryManagementService
    {
        ...
        /// <param name="category">A product category to return.</param>
        /// <returns>Returns true if a product category is returned; otherwise false.</returns>
        bool TryShowCategoryAsync(int categoryId, out Category category);

        /// <summary>
        /// Creates a new product category.
        /// </summary>
        /// <param name="Category">A <see cref="Category"/> to create.</param>
        ...
        Task<bool> UpdateCategoriesAsync(int categoryId, Category category);
    }
}
